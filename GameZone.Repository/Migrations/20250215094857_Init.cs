    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "DateOFDelete", "IsDeleted", "Name" },
                values: new object[,]
                {
                    { 1, null, false, "Sports" },
                    { 2, null, false, "Action" },
                    { 3, null, false, "Adventure" },
                    { 4, null, false, "Racing" },
                    { 5, null, false, "Fighting" },
                    { 6, null, false, "Film" }
                });

            migrationBuilder.InsertData(
                table: "Devices",
                columns: new[] { "Id", "DateOFDelete", "Icon", "IsDeleted", "Name" },
                values: new object[,]
                {
                    { 1, null, "bi bi-playstation", false, "PlayStation" },
                    { 2, null, "bi bi-xbox", false, "xbox" },
                    { 3, null, "bi bi-nintendo-switch", false, "Nintendo Switch" },
                    { 4, null, "bi bi-pc-display", false, "PC" }
                });
